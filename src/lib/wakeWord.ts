 ...
 * entirely in the SARA browser tab.
 *
...
export class SaraWakeWordDetector {
  private recognition: SpeechRecognitionLike | null = null;
  private ctor: SpeechRecognitionCtor | null;
  private phrase = "hey sara";
  ...
  start(opts: WakeWordOptions): boolean {
    ...
    this.phrase = (opts.phrase || "hey sara").toLowerCase().trim();
  ...
  setPhrase(phrase: string): void {
    this.phrase = (phrase || "hey sara").toLowerCase().trim();
  }
